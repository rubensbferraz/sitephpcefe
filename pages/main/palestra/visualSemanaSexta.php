	<?php
		...
		$query = mysqli_query($conn, "SELECT date_format(dataPalestra, '%d-%m-%Y') as DataPalestra, oradorPalestra, temaPalestra, diretorPalestra, semanaPalestra FROM tb_palestra where semanaPalestra='sexta'");
			...
			if ($dtPalestra[1]==$mes) {
				if($dtPalestra[0] >= $dia){
					...
					";break;
						...
						echo "
						<div class='sexta border border-success p-2 rounded'>
						<p class='sem text-uppercase'> ". strtoupper($sem)."  / Dia:&nbsp &nbsp </p>
