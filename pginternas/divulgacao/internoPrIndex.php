...
<body>
    <div class="internoPr container-flued p-2 ml-5 mr-5">
        <span class="text-center col-md">Nossa Atividade de Evangelização</span>
        <div class="row">
            <div class="col-md col-sm card">
                <div class="">
                    <div class="p-2">
                        <img class="card-img-top" src="pginternas/evangelizacao/imagens/imagemCampoUm.png" alt="" srcset="">
            ...
            <div class="col-md col-sm card">
                <div class="">
                    <div class="col p-2">
                        <img class="card-img-top" src="pginternas/evangelizacao/imagens/imagemCampoDois.png" alt="" srcset="">
                        <p class="text-justify">Porque nós o usamos?<br>
            ...
            <div class="col-md col-sm card">
                <div class="">
                    <div class="col p-2">
                    <p class="text-justify">
                        <img class="card-img-top" src="pginternas/evangelizacao/imagens/imagemCampoTres.png" alt="" srcset="">
                        Onde posso conseguí-lo?<br>
